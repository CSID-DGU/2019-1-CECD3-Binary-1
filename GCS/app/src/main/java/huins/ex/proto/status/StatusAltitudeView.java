 ...
 */
public class StatusAltitudeView extends StatusCustomButton {
    ...
    public StatusAltitudeView(Context context) {
        super(context);

        initialize();
    }

    public StatusAltitudeView(Context context, AttributeSet attrs) {
        super(context, attrs);

        initialize();
    }

    public StatusAltitudeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public StatusAltitudeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
