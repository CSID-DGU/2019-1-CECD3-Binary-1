...
import huins.ex.proto.mission.item.command.SetRelay;
...
public class ProxyUtils {
    ...
    public static huins.ex.core.mission.MissionItem getMissionItemImpl(Mission mission, MissionItem proxyItem) {
        if (proxyItem == null)
            return null;

        huins.ex.core.mission.MissionItem missionItemImpl;
        switch (proxyItem.getType()) {

            case CAMERA_TRIGGER: {
                CameraTrigger proxy = (CameraTrigger) proxyItem;

                huins.ex.core.mission.commands.CameraTrigger temp = new huins.ex
            ...
            case CHANGE_SPEED: {
                ...
                huins.ex.core.mission.commands.ChangeSpeed temp = new huins.ex
            ...
            case EPM_GRIPPER: {
                ...
                huins.ex.core.mission.commands.EpmGripper temp = new huins.ex
            ...
            case SET_SERVO: {
                ...
                huins.ex.core.mission.commands.SetServo temp = new huins.ex.core
            ...
            case TAKEOFF: {
                ...
                huins.ex.core.mission.commands.Takeoff temp = new huins.ex.core
            ...
            case CIRCLE: {
                ...
                huins.ex.core.mission.waypoints.Circle temp = new huins.ex.core
            ...
            case LAND: {
                ...
                huins.ex.core.mission.waypoints.Land temp = new huins.ex.core
            ...
            case REGION_OF_INTEREST: {
                ...
                huins.ex.core.mission.waypoints.RegionOfInterest temp = new huins.ex
                        .core.mission.waypoints.RegionOfInterest(mission,
            ...
            case SPLINE_WAYPOINT: {
                ...
                huins.ex.core.mission.waypoints.SplineWaypoint temp = new huins.ex
                        .core.mission.waypoints.SplineWaypoint(mission,
                        MathUtils.latLongAltToCoord3D(proxy.getCoordinate()));
            ...
            case STRUCTURE_SCANNER: {
                ...
                huins.ex.core.mission.waypoints.StructureScanner temp = new huins.ex
                        .core.mission.waypoints.StructureScanner(mission,
                        MathUtils.latLongAltToCoord3D(proxy.getCoordinate()));
            ...
            case WAYPOINT: {
                ...
                huins.ex.core.mission.waypoints.Waypoint temp = new huins.ex.core
            ...
            case SURVEY: {
                ...
                huins.ex.core.mission.survey.Survey temp = new huins.ex.core
    ...
    public static MissionItem getProxyMissionItem(huins.ex.core.mission.MissionItem itemImpl) {
        if (itemImpl == null)
            return null;
        ...
        switch (itemImpl.getType()) {
            case WAYPOINT: {
                huins.ex.core.mission.waypoints.Waypoint source = (huins.ex.core.mission.waypoints.Waypoint) itemImpl;
            ...
            case SPLINE_WAYPOINT: {
                huins.ex.core.mission.waypoints.SplineWaypoint source = (huins.ex.core.mission.waypoints.SplineWaypoint) itemImpl;
            ...
            case TAKEOFF: {
                huins.ex.core.mission.commands.Takeoff source = (huins.ex.core.mission.commands.Takeoff) itemImpl;
            ...
            case LAND: {
                huins.ex.core.mission.waypoints.Land source = (huins.ex.core.mission.waypoints.Land) itemImpl;
            ...
            case CIRCLE: {
                huins.ex.core.mission.waypoints.Circle source = (huins.ex.core.mission.waypoints.Circle) itemImpl;
            ...
            case ROI: {
                huins.ex.core.mission.waypoints.RegionOfInterest source = (huins.ex.core.mission.waypoints.RegionOfInterest) itemImpl;
            ...
            case SURVEY: {
                huins.ex.core.mission.survey.Survey source = (huins.ex.core.mission.survey.Survey) itemImpl;
            ...
            case CYLINDRICAL_SURVEY: {
                huins.ex.core.mission.waypoints.StructureScanner source = (huins.ex.core.mission.waypoints.StructureScanner) itemImpl;
            ...
            case CHANGE_SPEED: {
                huins.ex.core.mission.commands.ChangeSpeed source = (huins.ex.core.mission.commands.ChangeSpeed) itemImpl;
            ...
            case CAMERA_TRIGGER: {
                huins.ex.core.mission.commands.CameraTrigger source = (huins.ex.core.mission.commands.CameraTrigger) itemImpl;
            ...
            case EPM_GRIPPER: {
                huins.ex.core.mission.commands.EpmGripper source = (huins.ex.core.mission.commands.EpmGripper) itemImpl;
            ...
            case SET_SERVO: {
                huins.ex.core.mission.commands.SetServo source = (huins.ex.core.mission.commands.SetServo) itemImpl;
